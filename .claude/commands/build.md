...
1. Если в `$ARGUMENTS` указан путь к артефакту плана (`_bmad-output/planning-artifacts/[feature]-plan.md`) — прочитай его. Если указано текстовое описание — используй его напрямую. Если аргументов нет — используй контекст текущего разговора.
...
После каждого шага обнови `_bmad-output/planning-artifacts/[feature]-progress.md`:
