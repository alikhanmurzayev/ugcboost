...
4. **CI на PR после push.** `gh pr checks <num> --watch --interval 30 --fail-fast`. Если упёрся в 10-минутный Bash-таймаут — повторить, пока не дождётся финального статуса. Любой не-зелёный — стоп.
