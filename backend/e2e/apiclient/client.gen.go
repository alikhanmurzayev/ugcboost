...
type ClientInterface interface {
	...
	UpdateCampaignWithBody(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// AddCampaignCreatorsWithBody request with any body
	AddCampaignCreatorsWithBody(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	AddCampaignCreators(ctx context.Context, id openapi_types.UUID, body AddCampaignCreatorsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// RemindCampaignCreatorsSigningWithBody request with any body
	RemindCampaignCreatorsSigningWithBody(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	RemindCampaignCreatorsSigning(ctx context.Context, id openapi_types.UUID, body RemindCampaignCreatorsSigningJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) UpdateCampaignWithBody(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) ListCampaignCreators(ctx context.Context, id openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListCampaignCreatorsRequest(c.Server, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddCampaignCreatorsWithBody(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddCampaignCreatorsRequestWithBody(c.Server, id, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddCampaignCreators(ctx context.Context, id openapi_types.UUID, body AddCampaignCreatorsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddCampaignCreatorsRequest(c.Server, id, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) RemindCampaignCreatorsSigningWithBody(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewRemindCampaignCreatorsSigningRequestWithBody(c.Server, id, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) RemindCampaignCreatorsSigning(ctx context.Context, id openapi_types.UUID, body RemindCampaignCreatorsSigningJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewRemindCampaignCreatorsSigningRequest(c.Server, id, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) TmaAgree(ctx context.Context, secretToken TmaSecretTokenPathParam, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewTmaAgreeRequest(c.Server, secretToken)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewUpdateCampaignRequest(server string, id openapi_types.UUID, body UpdateCampaignJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewUpdateCampaignRequestWithBody(server string, id openapi_types.UUID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewListCampaignCreatorsRequest(server string, id openapi_types.UUID) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/campaigns/%s/creators", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewAddCampaignCreatorsRequest calls the generic AddCampaignCreators builder with application/json body
func NewAddCampaignCreatorsRequest(server string, id openapi_types.UUID, body AddCampaignCreatorsJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewAddCampaignCreatorsRequestWithBody(server, id, "application/json", bodyReader)
}

// NewAddCampaignCreatorsRequestWithBody generates requests for AddCampaignCreators with any type of body
func NewAddCampaignCreatorsRequestWithBody(server string, id openapi_types.UUID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewRemoveCampaignCreatorRequest generates requests for RemoveCampaignCreator
func NewRemoveCampaignCreatorRequest(server string, id openapi_types.UUID, creatorId openapi_types.UUID) (*http.Request, error) {
	var err error
...
// NewRemindCampaignCreatorsSigningRequest calls the generic RemindCampaignCreatorsSigning builder with application/json body
func NewRemindCampaignCreatorsSigningRequest(server string, id openapi_types.UUID, body RemindCampaignCreatorsSigningJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewRemindCampaignCreatorsSigningRequestWithBody(server, id, "application/json", bodyReader)
}

// NewRemindCampaignCreatorsSigningRequestWithBody generates requests for RemindCampaignCreatorsSigning with any type of body
func NewRemindCampaignCreatorsSigningRequestWithBody(server string, id openapi_types.UUID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/campaigns/%s/remind-signing", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewTmaAgreeRequest(server string, secretToken TmaSecretTokenPathParam) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/tma/campaigns/%s/agree", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewTmaDeclineRequest generates requests for TmaDecline
func NewTmaDeclineRequest(server string, secretToken TmaSecretTokenPathParam) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/tma/campaigns/%s/decline", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	UpdateCampaignWithBodyWithResponse(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateCampaignResponse, error)
	...
	// AddCampaignCreatorsWithBodyWithResponse request with any body
	AddCampaignCreatorsWithBodyWithResponse(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddCampaignCreatorsResponse, error)

	AddCampaignCreatorsWithResponse(ctx context.Context, id openapi_types.UUID, body AddCampaignCreatorsJSONRequestBody, reqEditors ...RequestEditorFn) (*AddCampaignCreatorsResponse, error)
	...
	// RemindCampaignCreatorsSigningWithBodyWithResponse request with any body
	RemindCampaignCreatorsSigningWithBodyWithResponse(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*RemindCampaignCreatorsSigningResponse, error)

	RemindCampaignCreatorsSigningWithResponse(ctx context.Context, id openapi_types.UUID, body RemindCampaignCreatorsSigningJSONRequestBody, reqEditors ...RequestEditorFn) (*RemindCampaignCreatorsSigningResponse, error)
...
type ListCampaignCreatorsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ListCampaignCreatorsResult
	JSON401      *ErrorResponse
	JSON403      *Forbidden
	JSON404      *ErrorResponse
	JSONDefault  *UnexpectedError
...
// Status returns HTTPResponse.Status
func (r ListCampaignCreatorsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ListCampaignCreatorsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type AddCampaignCreatorsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON201      *AddCampaignCreatorsResult
	JSON401      *ErrorResponse
	JSON403      *Forbidden
	JSON404      *ErrorResponse
	JSON422      *ErrorResponse
...
// Status returns HTTPResponse.Status
func (r AddCampaignCreatorsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r AddCampaignCreatorsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type RemoveCampaignCreatorResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON401      *ErrorResponse
	JSON403      *Forbidden
...
// Status returns HTTPResponse.Status
func (r RemoveCampaignCreatorResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
type RemindCampaignCreatorsSigningResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *CampaignNotifyResult
	JSON401      *ErrorResponse
...
// Status returns HTTPResponse.Status
func (r RemindCampaignCreatorsSigningResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r RemindCampaignCreatorsSigningResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// Status returns HTTPResponse.Status
func (r TmaAgreeResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r TmaAgreeResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type TmaDeclineResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *TmaDecisionResult
	JSON401      *ErrorResponse
...
// Status returns HTTPResponse.Status
func (r TmaDeclineResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r TmaDeclineResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
func (c *ClientWithResponses) UpdateCampaignWithBodyWithResponse(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateCampaignResponse, error) {
...
func (c *ClientWithResponses) UpdateCampaignWithResponse(ctx context.Context, id openapi_types.UUID, body UpdateCampaignJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateCampaignResponse, error) {
...
func (c *ClientWithResponses) ListCampaignCreatorsWithResponse(ctx context.Context, id openapi_types.UUID, reqEditors ...RequestEditorFn) (*ListCampaignCreatorsResponse, error) {
	rsp, err := c.ListCampaignCreators(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseListCampaignCreatorsResponse(rsp)
}

// AddCampaignCreatorsWithBodyWithResponse request with arbitrary body returning *AddCampaignCreatorsResponse
func (c *ClientWithResponses) AddCampaignCreatorsWithBodyWithResponse(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddCampaignCreatorsResponse, error) {
	rsp, err := c.AddCampaignCreatorsWithBody(ctx, id, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAddCampaignCreatorsResponse(rsp)
}

func (c *ClientWithResponses) AddCampaignCreatorsWithResponse(ctx context.Context, id openapi_types.UUID, body AddCampaignCreatorsJSONRequestBody, reqEditors ...RequestEditorFn) (*AddCampaignCreatorsResponse, error) {
	rsp, err := c.AddCampaignCreators(ctx, id, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAddCampaignCreatorsResponse(rsp)
...
// RemoveCampaignCreatorWithResponse request returning *RemoveCampaignCreatorResponse
func (c *ClientWithResponses) RemoveCampaignCreatorWithResponse(ctx context.Context, id openapi_types.UUID, creatorId openapi_types.UUID, reqEditors ...RequestEditorFn) (*RemoveCampaignCreatorResponse, error) {
	rsp, err := c.RemoveCampaignCreator(ctx, id, creatorId, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// RemindCampaignCreatorsSigningWithBodyWithResponse request with arbitrary body returning *RemindCampaignCreatorsSigningResponse
func (c *ClientWithResponses) RemindCampaignCreatorsSigningWithBodyWithResponse(ctx context.Context, id openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*RemindCampaignCreatorsSigningResponse, error) {
	rsp, err := c.RemindCampaignCreatorsSigningWithBody(ctx, id, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseRemindCampaignCreatorsSigningResponse(rsp)
}

func (c *ClientWithResponses) RemindCampaignCreatorsSigningWithResponse(ctx context.Context, id openapi_types.UUID, body RemindCampaignCreatorsSigningJSONRequestBody, reqEditors ...RequestEditorFn) (*RemindCampaignCreatorsSigningResponse, error) {
	rsp, err := c.RemindCampaignCreatorsSigning(ctx, id, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseRemindCampaignCreatorsSigningResponse(rsp)
...
func (c *ClientWithResponses) TmaAgreeWithResponse(ctx context.Context, secretToken TmaSecretTokenPathParam, reqEditors ...RequestEditorFn) (*TmaAgreeResponse, error) {
	rsp, err := c.TmaAgree(ctx, secretToken, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseTmaAgreeResponse(rsp)
}

// TmaDeclineWithResponse request returning *TmaDeclineResponse
func (c *ClientWithResponses) TmaDeclineWithResponse(ctx context.Context, secretToken TmaSecretTokenPathParam, reqEditors ...RequestEditorFn) (*TmaDeclineResponse, error) {
	rsp, err := c.TmaDecline(ctx, secretToken, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ParseListCampaignCreatorsResponse parses an HTTP response from a ListCampaignCreatorsWithResponse call
func ParseListCampaignCreatorsResponse(rsp *http.Response) (*ListCampaignCreatorsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &ListCampaignCreatorsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest ListCampaignCreatorsResult
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseAddCampaignCreatorsResponse parses an HTTP response from a AddCampaignCreatorsWithResponse call
func ParseAddCampaignCreatorsResponse(rsp *http.Response) (*AddCampaignCreatorsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &AddCampaignCreatorsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 201:
		var dest AddCampaignCreatorsResult
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON201 = &dest
...
// ParseRemoveCampaignCreatorResponse parses an HTTP response from a RemoveCampaignCreatorWithResponse call
func ParseRemoveCampaignCreatorResponse(rsp *http.Response) (*RemoveCampaignCreatorResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &RemoveCampaignCreatorResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseRemindCampaignCreatorsSigningResponse parses an HTTP response from a RemindCampaignCreatorsSigningWithResponse call
func ParseRemindCampaignCreatorsSigningResponse(rsp *http.Response) (*RemindCampaignCreatorsSigningResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &RemindCampaignCreatorsSigningResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseTmaAgreeResponse parses an HTTP response from a TmaAgreeWithResponse call
func ParseTmaAgreeResponse(rsp *http.Response) (*TmaAgreeResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
// ParseTmaDeclineResponse parses an HTTP response from a TmaDeclineWithResponse call
func ParseTmaDeclineResponse(rsp *http.Response) (*TmaDeclineResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
