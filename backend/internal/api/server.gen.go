...
type CreatorApplicationDetailData struct {
	...
	// TelegramLink Telegram account linked to this application via the /start deep-link.
...
type TelegramLink struct {
	...
	// TelegramFirstName Telegram first_name at link time. Nullable — Telegram may omit it.
	TelegramFirstName *string `json:"telegramFirstName,omitempty"`

	// TelegramLastName Telegram last_name at link time. Nullable — Telegram may omit it.
	...
	// TelegramUsername Telegram @username at link time (no leading @). Nullable — not every Telegram user sets one.
