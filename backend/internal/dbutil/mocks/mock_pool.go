...
func (_mock *MockPool) Begin(ctx context.Context) (pgx.Tx, error) {
...
func (_c *MockPool_Begin_Call) Return(tx pgx.Tx, err error) *MockPool_Begin_Call {
	_c.Call.Return(tx, err)
	return _c
}

func (_c *MockPool_Begin_Call) RunAndReturn(run func(ctx context.Context) (pgx.Tx, error)) *MockPool_Begin_Call {
	_c.Call.Return(run)
	return _c
}
