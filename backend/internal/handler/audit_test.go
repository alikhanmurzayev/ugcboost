...
func TestServer_ListAuditLogs(t *testing.T) {
	...
	t.Run("admin success no filters full equality", func(t *testing.T) {
		...
		router := newTestRouter(t, NewServer(nil, nil, authz, audit, nil, nil, nil, nil, nil, nil, nil, nil, ServerConfig{Version: "test-version"}, logmocks.NewMockLogger(t)))
	...
	t.Run("service error returns 500", func(t *testing.T) {
		...
		router := newTestRouter(t, NewServer(nil, nil, authz, audit, nil, nil, nil, nil, nil, nil, nil, nil, ServerConfig{Version: "test-version"}, log))
...
func newServerForRawJSON(log *logmocks.MockLogger) *Server {
	return NewServer(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, ServerConfig{Version: "test-version"}, log)
}
