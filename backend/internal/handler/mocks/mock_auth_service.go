...
// MockAuthService_SeedUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SeedUser'
type MockAuthService_SeedUser_Call struct {
	*mock.Call
}
...
//   - password string
//   - role string
func (_e *MockAuthService_Expecter) SeedUser(ctx interface{}, email interface{}, password interface{}, role interface{}) *MockAuthService_SeedUser_Call {
	return &MockAuthService_SeedUser_Call{Call: _e.mock.On("SeedUser", ctx, email, password, role)}
}

func (_c *MockAuthService_SeedUser_Call) Run(run func(ctx context.Context, email string, password string, role string)) *MockAuthService_SeedUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
