...
// AssertActiveCampaigns provides a mock function for the type MockCampaignService
func (_mock *MockCampaignService) AssertActiveCampaigns(ctx context.Context, ids []string) error {
...
// MockCampaignService_AssertActiveCampaigns_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AssertActiveCampaigns'
type MockCampaignService_AssertActiveCampaigns_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - ids []string
func (_e *MockCampaignService_Expecter) AssertActiveCampaigns(ctx interface{}, ids interface{}) *MockCampaignService_AssertActiveCampaigns_Call {
	return &MockCampaignService_AssertActiveCampaigns_Call{Call: _e.mock.On("AssertActiveCampaigns", ctx, ids)}
}

func (_c *MockCampaignService_AssertActiveCampaigns_Call) Run(run func(ctx context.Context, ids []string)) *MockCampaignService_AssertActiveCampaigns_Call {
...
func (_c *MockCampaignService_AssertActiveCampaigns_Call) Return(err error) *MockCampaignService_AssertActiveCampaigns_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockCampaignService_AssertActiveCampaigns_Call) RunAndReturn(run func(ctx context.Context, ids []string) error) *MockCampaignService_AssertActiveCampaigns_Call {
	_c.Call.Return(run)
	return _c
}
