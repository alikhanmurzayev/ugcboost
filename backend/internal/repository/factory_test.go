...
func TestRepoFactory(t *testing.T) {
	...
	t.Run("NewCreatorApplicationStatusTransitionRepo returns repo bound to db", func(t *testing.T) {
		t.Parallel()
		repo := factory.NewCreatorApplicationStatusTransitionRepo(db)
		require.NotNil(t, repo)
		concrete, ok := repo.(*creatorApplicationStatusTransitionRepository)
	...
	t.Run("NewCampaignRepo returns CampaignRepo bound to db", func(t *testing.T) {
		t.Parallel()
		repo := factory.NewCampaignRepo(db)
		require.NotNil(t, repo)
		concrete, ok := repo.(*campaignRepository)
		require.True(t, ok, "factory returns *campaignRepository")
		require.Same(t, db, concrete.db)
	})

	t.Run("NewCampaignCreatorRepo returns CampaignCreatorRepo bound to db", func(t *testing.T) {
		t.Parallel()
		repo := factory.NewCampaignCreatorRepo(db)
		require.NotNil(t, repo)
		concrete, ok := repo.(*campaignCreatorRepository)
	...
	t.Run("NewTelegramMessageRepo returns TelegramMessageRepo bound to db", func(t *testing.T) {
		t.Parallel()
		repo := factory.NewTelegramMessageRepo(db)
		require.NotNil(t, repo)
		concrete, ok := repo.(*telegramMessageRepository)
		require.True(t, ok, "factory returns *telegramMessageRepository")
		require.Same(t, db, concrete.db)
	})
}
