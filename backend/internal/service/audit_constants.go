...
const (
	...
	AuditActionCampaignCreatorContractInitiated        = "campaign_creator.contract_initiated"
	AuditActionCampaignCreatorContractOrphanRecover    = "campaign_creator.contract_orphan_recovered"
