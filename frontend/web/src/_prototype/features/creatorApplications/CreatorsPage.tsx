...
export default function CreatorsPage() {
  const { t } = useTranslation(["prototype_creators", "prototype_creatorApplications"]);
  ...
  return (
    <div data-testid="creators-page">
      ...
      <p className="mt-1 text-sm text-gray-500">{t("prototype_creators:description")}</p>

      {listQuery.isLoading ? (
        <Spinner className="mt-6" />
      ) : listQuery.isError ? (
        <ErrorState
          message={t("prototype_creatorApplications:loadError")}
          ...
          <ApplicationsTable
            ...
            emptyMessage={
              isFilterActive(parseFilters(searchParams))
                ? t("prototype_creatorApplications:emptyFiltered")
                : t("prototype_creators:empty")
            }
          />
        </>
      )}
...
function buildColumns(t: (key: string) => string): Column<Application>[] {
  return [
    ...
    {
      key: "fullName",
      header: t("prototype_creatorApplications:columns.fullName"),
      render: (row) => (
    ...
    {
      key: "socials",
      header: t("prototype_creatorApplications:columns.socials"),
      render: (row) => (
        <div
    ...
    {
      key: "categories",
      header: t("prototype_creatorApplications:columns.categories"),
      render: (row) => <CategoryChips categories={row.categories} />,
    },
    {
      key: "age",
      header: t("prototype_creatorApplications:columns.age"),
    ...
    {
      key: "city",
      header: t("prototype_creatorApplications:columns.city"),
    ...
    {
      key: "rating",
      header: t("prototype_creators:columns.rating"),
      render: (row) =>
    ...
    {
      key: "completedOrders",
      header: t("prototype_creators:columns.completedOrders"),
    ...
    {
      key: "activeOrders",
      header: t("prototype_creators:columns.activeOrders"),
