    ...
    <div className="mt-4 border-t border-surface-200 pt-4">
      <form onSubmit={handleSubmit} className="flex items-end gap-3">
        <div className="flex-1">
          <label className="mb-1 block text-sm font-medium text-gray-700">Email менеджера</label>
          <input
            type="email"
            value={email}
      ...
      {tempPassword && (
        <div className="mt-3 rounded-button bg-green-50 p-3 text-sm">
          <p className="font-medium text-green-800">Новый менеджер создан. Временный пароль:</p>
