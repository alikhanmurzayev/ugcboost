...
interface DrawerCreatorFiltersProps {
  filters: FilterValues;
  onChange: (next: FilterValues) => void;
}

export default function DrawerCreatorFilters({
  filters,
  onChange,
}: DrawerCreatorFiltersProps) {
  ...
  return (
    <div
      ...
      data-testid="drawer-creator-filters"
    >
      <div className="relative">
        ...
        <input
          ...
          data-testid="drawer-filters-search"
        />
      </div>
      <button
        type="button"
        ...
        data-testid="drawer-filters-toggle"
      ...
      {active && (
        <button
          ...
          data-testid="drawer-filters-reset"
        >
          {t("filters.reset")}
        </button>
      )}
      ...
      {open && (
        <div
          ...
          data-testid="drawer-filters-popover"
        ...
        >
          <FilterRow label={t("filters.date")}>
            <DateRangePicker
              ...
              testid="drawer-filter-date-range"
            />
          </FilterRow>
          ...
          <FilterRow label={t("filters.age")} className="mt-3">
            <div className="flex items-center gap-2">
              <input
                ...
                data-testid="drawer-filter-age-from"
              ...
              <input
                ...
                className="w-20 rounded-button border border-gray-300 px-2 py-1 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary-100"
                data-testid="drawer-filter-age-to"
          ...
          <FilterRow label={t("filters.categories")} className="mt-3">
            <SearchableMultiselect
              ...
              testid="drawer-filter-categories"
            />
          </FilterRow>
        </div>
      )}
